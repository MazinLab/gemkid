...
from ..beta2.layers import drawing_to_sonnet, drawing_to_sonnet_3d


@dataclass(frozen=True, eq=True)
class B1Testbench(simulate.LeftFeedlineTestbench):
    delta: float = 0.25
