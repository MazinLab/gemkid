...
class B2MTestbench(simulate.LeftFeedlineTestbench):
    delta: float = 0.25
...
class B2MCMD(GeMKIDCMD):
    def _testbench_from_cell(self, cell, geometry, ns) -> simulate.TestbenchABC:
        return B2MTestbench(cell, geometry.feedline, 1.0, stub=10)
