...
HF_SONNET = SonnetMetalLayer((1, 0), "hf", 0, SonnetPlanarGeneral(1e-7, 0, 0, 23.0), 200.0)
HF_VAR_SONNET = SonnetMetalLayer((1, 1), "hf_var", 0, SonnetPlanarGeneral(1e-7, 0, 0, 123.0), 200.0)
...
HF_SONNET_3D = SonnetMetalLayer((1, 0), "hf", 0, SonnetPlanarGeneral(1e-7, 0, 0, 23.0), 200.0)
HF_VAR_SONNET_3D = SonnetMetalLayer((1, 1), "hf_var", 0, SonnetPlanarGeneral(1e-7, 0, 0, 123.0), 200.0)
