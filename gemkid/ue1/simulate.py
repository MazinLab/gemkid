...
if __name__ == "__main__":
    ...
    def fit(testcase, f_range=()):
        import loopfit
        import numpy as np

        f, i, q = loopfit.load_touchstone(testcase._filename.split(".")[0] + ".ts")
